...
Pour l'instant j'ai appelé l'appli **mapd** et j'ai fait un faux logo vite fait pour la démo.
...
- modifier la fonction get_rect_bounds pour pouvoir l'utiliser dans le module regional_models.
